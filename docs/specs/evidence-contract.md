...
Deterministic matching tests the stored correct prediction first. When the learner answer equals it, every alternative is `weakened`, even if one or more alternative predictions collide with the correct prediction.

- The correct answer matches: all alternatives are `weakened`.
